...
void Block::render()
{
    ...
    {
    case NORMAL:
        putimage(m_x, m_y, imgBlock[0]);
        break;
    case CHOSEN:
        putimage(m_x, m_y, imgBlock[1]);
        break;
    case FLAG:
        putimage(m_x, m_y, imgFlag[0]);
        break;
    case FLAG_CHOSEN:
        putimage(m_x, m_y, imgFlag[1]);
        break;
    case UNKNOWN:
        putimage(m_x, m_y, imgUnknown[0]);
        break;
    case UNKNOWN_CHOSEN:
        putimage(m_x, m_y, imgUnknown[1]);
        break;
    case WRONGFLAG:
        putimage(m_x, m_y, imgMine[8]);
        break;
    case SPACE:
    case FOUND:
...
void MineArray::moveFrame(int x, int y)
{
    ...
    {
    case NORMAL:
        putimage(a, b, m_imgBlock[1]);
        break;
    case FLAG:
        putimage(a, b, m_imgFlag[1]);
        break;
    case UNKNOWN:
        putimage(a, b, m_imgUnknown[1]);
        break;
    default:;
    }
}
